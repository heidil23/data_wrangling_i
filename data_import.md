...
Skimr feature tells you how many missing values there are and some basic
descriptive statistics. It also prints out a histogram of numeric
variables.
...
In the console, type “view(litters\_df)” but avoid putting it in a code
chunk the R markdown document.

Note: <dbl> is a specific type of number variable

## Options to read\_csv

Check out ‘?read\_csv’ for more information, opens help file for the
read\_csv function
...
Check out ‘?read\_excel’ for more information, opens help file for the
read\_csv function
